...
The list of namesspaces and labels are supplied to the deployment using an environment variable as a json string. In the example deployment below, I used nginx as main application but this could be any application
